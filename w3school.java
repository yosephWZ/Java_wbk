...
/* ______________________ Java Data Types
...
class w3school extends Vehicle {
...
// Import a Package ....diffrence b/n pakcage and class
...
public class w3school extends Thread {
  public void run() {
...
// Implement Syntax
public class w3school implements Runnable {
  public void run() {
    System.out.println("This code is running in a thread");
  }
}
...
50. Write a Java program to sort an array of positive integers of an given array, in the sorted array the value of the first element should be maximum, second value should be minimum value, third should be second maximum, fourth second be second minimum and so on.   
...
53. Write a Java program to replace every element with the next greatest element (from right side) in an given array of integers.   
*/
...
/* Java Date, Time and Calendar Exercises
